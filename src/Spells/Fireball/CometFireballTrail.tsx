...
interface CometFireballTrailProps {
  color: THREE.Color;
  size: number;
...
const CometFireballTrail: React.FC<CometFireballTrailProps> = ({
  color,
  size,
  meshRef,
  opacity = 1
  ...
  useFrame(() => {
    ...
    // Shift particles to create trail effect
    for (let i = particlesCount - 1; i > 0; i--) {
      ...
      // Adjust opacity and scale for comet-like effect
...
export default CometFireballTrail; 