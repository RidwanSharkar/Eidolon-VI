...
const ElementalTrail: React.FC<ElementalTrailProps> = ({
  color,
  size,
  meshRef,
  opacity = 1
  ...
  useFrame(() => {
    ...
    // Get world position for accurate tracking - reuse ref
    meshRef.current.getWorldPosition(worldPositionRef.current);
      ...
      <shaderMaterial
        ...
        fragmentShader={`
          ...
          void main() {
            ...
            vec3 glowColor = mix(uColor, vec3(1.0, 1.0, 1.0), 0.3);
