...
const HolyTrail: React.FC<HolyTrailProps> = ({
  color,
  size,
  meshRef,
  opacity = 1
      ...
      <shaderMaterial
        ...
        fragmentShader={`
          ...
          void main() {
            ...
            // Holy golden glow effect
            vec3 glowColor = mix(uColor, vec3(1.0, 1.0, 0.9), 0.4);
