...
const LavaLashTrail: React.FC<LavaLashTrailProps> = ({
  color,
  size,
  meshRef,
  opacity = 1
      ...
      <shaderMaterial
        ...
        fragmentShader={`
          ...
          void main() {
            ...
            // Fire effect with hot colors
            vec3 glowColor = mix(uColor, vec3(1.0, 0.8, 0.2), 0.5);
