...
// Get level-based colors (same as Pillar and Sky components)
...
const SimpleBorderEffects: React.FC<SimpleBorderEffectsProps> = ({
  ...
  const levelColors = useMemo(() => getLevelColors(level), [level]);
  ...
  }, [particlePositions, glowPositions, level]); // Added level to ensure matrices are restored on level up
