...
export const DEFAULT_WEAPON_ABILITIES: Record<WeaponType, WeaponAbilities> = {
  [WeaponType.SCYTHE]: {
    ...
    r: { key: 'r', cooldown: 15, currentCooldown: 0, icon: '/Eidolon/icons/r1.svg', maxCooldown: 8, name: 'Bonespear' },
  ...
  [WeaponType.SWORD]: {
    ...
    r: { key: 'r', cooldown: 15, currentCooldown: 0, icon: '/Eidolon/icons/r2.svg', maxCooldown: 12, name: 'Retribute' },
  ...
  [WeaponType.SABRES2]: {
    q: { key: 'q', cooldown: 0.55, currentCooldown: 0, icon: '/Eidolon/icons/q4.svg', maxCooldown: 1.5, name: 'Sabres2 Q' },
