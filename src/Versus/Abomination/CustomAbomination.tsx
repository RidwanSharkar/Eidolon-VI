import { BoxGeometry, ConeGeometry, CylinderGeometry, Group, Mesh, MeshStandardMaterial, Shape, SphereGeometry, InstancedMesh, Matrix4, Vector3, Euler, Quaternion, ExtrudeGeometry } from 'three';
...
// MEMORY FIX: Create blade geometry once at module level
const BLADE_SHAPE = (() => {
