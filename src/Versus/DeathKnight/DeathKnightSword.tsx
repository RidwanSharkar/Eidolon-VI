...
import { Shape, AdditiveBlending, CylinderGeometry, TorusGeometry, ConeGeometry, SphereGeometry, ExtrudeGeometry } from 'three';
    ...
    <group rotation={[-0.575, 0, 0.2]} scale={[1.6, 1.6, 1.6]}>
      ...
      >
        ...
        <group position={[0, 0.8, 0.56]} rotation={[0, -Math.PI / 2, Math.PI / 2]}>
          {/* Base blade */}
          <mesh geometry={DEATH_KNIGHT_SWORD_GEOMETRIES.blade}>
            <meshStandardMaterial 
          ...
          <mesh geometry={DEATH_KNIGHT_SWORD_GEOMETRIES.innerBlade}>
            <meshStandardMaterial 
              color="#DDA0DD"  // Plum
              emissive="#DA70D6" // Orchid emission
              emissiveIntensity={3}
